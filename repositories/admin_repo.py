...
async def change_account_state_repo(role: Action_UserRole, action: Action, user_id: int, update_date_func = update_query) -> int | None:
    """
    ...
    :param user_id: int
    :param update_date_func: callable, default is mock_update_query
    :return: int | None -- updated row count
    """
...
async def soft_delete_course_repo(course_id: int, update_date_func = update_query) -> int | None:
    """
    :param course_id: int
    :param update_date_func: callable, default is mock_update_query
